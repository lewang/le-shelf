...
;;
;; The buffer-flip entrance in the same "project" spirit -- cycling only the
;; current `w' workspace's buffers -- lives in le-project-flip.el
;; (`le::project-flip'), which pulls in buffer-flip.
